...
// memastikan ID ada di URL dan valid
...
<body>
    <div class="container mt-3">
        ...
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                <div class="col-md-4">
                    <img src="https://wallpaperaccess.com/1920x1080-hd-sunset" class="img-fluid rounded-start" alt="User Image">
                </div>
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text"><?php echo "No HP :  ".htmlspecialchars($detail['nohp']); ?></p> <!-- Tampilkan no_hp dari database -->
